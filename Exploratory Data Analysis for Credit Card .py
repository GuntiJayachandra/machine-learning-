...
customer = pd.read_csv(r"D:\archive (2)\Customer Acqusition.csv",usecols=["Customer","Age","City","Product","Limit","Company","Segment"])
repay = pd.read_csv(r"D:\archive (2)\Repayment.csv",usecols = ["Customer","Month","Amount"])
spend = pd.read_csv(r"D:\archive (2)\spend.csv",usecols=["Customer","Month","Type","Amount"])
...
repay["Month"] = pd.to_datetime(repay["Month"],format='%Y-%m-%d')
...
customer_spend["Month"] = pd.to_datetime(customer_spend["Month"],format='%Y-%m-%d')
...
customer_repay['Month'] = pd.to_datetime(customer_repay['Month'],format='%Y-%m-%d')
